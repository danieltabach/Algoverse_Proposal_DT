...
- Extract: their item-generation + crowdworker-validation pipeline; **check Figure 2 / interactive site for whether religion personas showed scale trends** (open to-do). Datasets: https://github.com/anthropics/evals
